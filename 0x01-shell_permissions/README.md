...
12-directory_permissions - Create a script that creates a directory called  with permissions 751 in the working directory.

13-change_group - Write a script that changes the group owner to for the file hello The file hello will be in the working directory
...
15-Symbolic linksWrite a script that changes the owner and the group owner of _hello to vincent and staff respectively.
...
100-Star_Wars - Write a script that will play the StarWars IV episode 
